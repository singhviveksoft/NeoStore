...
class SofaFragment : Fragment(),ProductListAdapter.clickItem  {
    ...
    override fun onClick(productlist: ProductListData) {
        ...
        val action=  SofaFragmentDirections.actionSofaFragmentToProductDetailFragment(productId,"Sofa")
